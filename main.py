...
#JH: Either import data or data2. They are variations.
...
for i in range(length):
    question= question_data[i]["question"] #extracting the question part only
    answer= question_data[i]["correct_answer"] #extracting the answer part only
...
while q_list.still_has_questions():
    ...
    print () #this is for printing a blank line between questions.
